...
public class MoikrugStrategy implements Strategy {
    ...
    protected Document getDocument(String searchString, int page) throws IOException {
        ...
        try {
            ...
            document = Jsoup.connect(html).userAgent("Mozilla/5.0 (Macintosh; Intel Mac OS X 10_14_4) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/73.0.3683.103 Safari/537.36").referrer("http://google.ru").get();
        } catch (IOException e) {
            e.printStackTrace();
        }
